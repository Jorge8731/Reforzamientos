...
- Crear un archivo principal (Ejer5.py) donde importará al módulo
creado.
...
from func import validacion_usuario

nombre_usuario = input("Ingrese el nombre de usuario: ")

resultado_validacion = validacion_usuario.validar_usuario(nombre_usuario)
